...
const (
	...
	brpcPackage    = protogen.GoImportPath("github.com/icexin/brpc-go")
)
...
func genService(gen *protogen.Plugin, file *protogen.File, g *protogen.GeneratedFile, service *protogen.Service) {
	...
	g.P("cc ", brpcPackage.Ident("ClientConn"))
	g.P("}")
	g.P()
	...
	g.P("func New", clientName, " (cc ", brpcPackage.Ident("ClientConn"), ") ", clientName, " {")
